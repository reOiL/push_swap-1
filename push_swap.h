...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/01/13 15:01:09 by eblackbu          #+#    #+#             */
/*   Updated: 2020/01/13 15:04:21 by eblackbu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*/
int					get_needed_astack(int elem, int n, \
									t_form **stacks, t_flag *flag_rr);
int					get_needed_bstack(int elem, int n, \
									t_form **stacks, t_flag *flag_rr);
